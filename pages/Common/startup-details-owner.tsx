    ...
    <Card className="shadow-lg">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {getCurrentProjects().map((project: Project) => (
...
const RecommendedInvestorsGrid = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {getCurrentInvestors().map((investor: Investor) => (
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction className="bg-red-600 hover:bg-red-700">Delete Startup</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
        ...
        <Dialog open={showSentimentDialog} onOpenChange={setShowSentimentDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Analyzing public sentiment about this startup...</DialogDescription>
            </DialogHeader>
            <div className="py-8">
              {sentimentLoading ? (
                <div className="text-center">
