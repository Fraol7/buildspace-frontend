...
import { projectData, recommendedInvestors, ALL_PROJECTS, type ProjectCard, type RecommendedInvestor } from "@/pages/Entrepreneur/shared-data"
    ...
    <Card className="shadow-lg">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {getCurrentProjects().map((project: ProjectCard) => (
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-bold text-gray-900 truncate mb-1">{user.name}</h3>
            <UserStarRating rating={user.rating} />
          </div>
        </div>

        <p className="text-gray-700 text-xs leading-relaxed mb-3 line-clamp-3">{user.bio}</p>
        ...
        <div className="flex justify-between gap-2 text-xs">
          ...
          {user.role === "Investor" && user.totalInvestment && (
            <div className="flex items-center gap-1 text-gray-600">
              ...
              <span>{user.totalInvestment}</span>
            </div>
          )}
        </div>
      </div>
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-gray-900">Recommended Investors</h3>
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {recommendedInvestors.map((investor: RecommendedInvestor) => (
          <InvestorCard key={investor.id} user={investor} />
        ))}
      </div>
    </div>
  )
...
export default function ProjectDetailsOwner() {
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="flex flex-col gap-2 lg:w-48">
              <div className="flex gap-2 justify-center lg:justify-end">
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white p-2" title="Edit Project">
