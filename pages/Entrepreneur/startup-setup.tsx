...
export default function StartupSetup() {
  ...
  const handleSubmitConfirm = () => {
    ...
    // In a real app, this would submit the project data and return a project ID
    console.log("Creating project:", formData)

    // Simulate project creation with an ID
    const newProjectId = `project_${Date.now()}`
    setCreatedProjectId(newProjectId)
    // setProjectCreated is not needed as we're using createdProjectId state
        ...
        <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Your startup has been set up successfully and is ready for investors to discover.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter className="flex gap-2">
              ...
              <Button
                onClick={() => {
                  ...
                  window.location.href = `/edit?id=${createdProjectId}`
                }}
