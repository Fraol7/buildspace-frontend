...
export default function StartupSetup() {
  ...
  const industryOptions = Object.entries(INDUSTRIES).map(([id, name]) => ({
    id,
    name,
  }));
  ...
  const handleSubmitConfirm = async () => {
    ...
    try {
      ...
      let logoUrl = "";
      if (formData.logo) {
        const urls = await uploadFiles([formData.logo], accessToken);
        logoUrl = urls[0] || "";
      }
      ...
      const payload = {
        ...
        industry: Number(formData.industries), // Ensure industry is a number
        funding_goal: parseFloat(formData.fundGoal) || 0,
        funding_stage: formData.startupStage,
        amount_raised: parseFloat(formData.amountRaised) || 0,
        business_model: "B2B",
        revenue: parseFloat(formData.revenue) || 0,
        location: formData.location,
      };

      const success = await createStartup(payload, accessToken);
      if (success) {
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to create this startup? Once created, it
                will be visible to potential investors.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Upload a square image (PNG, JPG) - Required
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("fundGoal", e.target.value)
                      }
                      placeholder="100000"
                      className="border-gray-300"
                    />
                    <p className="text-xs text-gray-500">
                      Target: {formatCurrency(formData.fundGoal || "0")}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("startupStage", value)
                      }
                    >
                      <SelectTrigger className="border-gray-300">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-gray-700">
                      Amount Raised So Far (Optional)
                    </Label>
                    <Input
                      type="number"
                      value={formData.amountRaised}
                      onChange={(e) =>
                        handleInputChange("amountRaised", e.target.value)
                      }
                      placeholder="0"
                      className="border-gray-300"
                    />
                    <p className="text-xs text-gray-500">
                      Raised: {formatCurrency(formData.amountRaised || "0")}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-gray-500">
                      Revenue: {formatCurrency(formData.revenue || "0")}
                    </p>
                  </div>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-gray-900">
                          {formatCurrency(formData.fundGoal)}
                        </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.industries ? (
                        <div className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-1 rounded">
                          {INDUSTRIES[Number(formData.industries)]}
                        </div>
                      ) : (
                ...
                <div className="space-y-3 text-sm text-gray-700">
                  {currentStep === 1 && (
                    <>
                      ...
                      <p>
                        • Keep your tagline clear and compelling - it&apos;s the
                        first thing investors see
                      </p>
                      <p>
                  ...
                  {currentStep === 2 && (
                    <>
                      <p>
                        • Select all industries that apply to your project from
                        the dropdown
                      </p>
                      <p>
                        • Be realistic with your funding goal based on actual
                        business needs
                      </p>
                      <p>
                        • Select the startup stage that best matches your
                        current situation
                      </p>
                      <p>
                        • Enter your location in the format &quot;City,
                        Country&quot; for better visibility
                      </p>
                    </>
                  )}
                  {currentStep === 3 && (
                    <>
                      <p>
                        • Review all information carefully - this is what
                        investors will see
                      </p>
                      <p>
                        • Make sure your project tells a complete and compelling
                        story
                      </p>
                      <p>
                        • Once created, you can always edit your project details
                        later
                      </p>
                    </>
                  )}
