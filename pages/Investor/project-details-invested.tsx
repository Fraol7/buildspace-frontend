...
import { projectData, ALL_PROJECTS } from "./shared-data"
...
export default function ProjectDetailsInvested() {
  ...
  const myInvestmentAmount = 25000 // Amount this investor has invested
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-4 md:py-8">
              ...
              <div className="flex-1 space-y-3 text-center sm:text-left">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3 justify-center sm:justify-start">
                    {projectData.industry.map((industry, index) => (
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            <div>
              <Card className="shadow-lg bg-white h-full">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-900">About This Project</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="flex items-center gap-2 mb-4 justify-center md:justify-start">
                    <div className="flex items-center">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          key={star}
                          className={`w-5 h-5 ${star <= projectData.founder.rating ? "fill-yellow-400 text-yellow-400" : "fill-gray-200 text-gray-200"}`}
                        />
                      ))}
                    </div>
          ...
          {/* Analytics Section - Invested users have access with their investment amount */}
          <Card className="shadow-lg bg-white">
            <CardHeader>
              <CardTitle className="text-xl text-gray-900">Investment Analytics</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <p className="text-xl md:text-2xl font-bold text-green-600">
                    {formatCurrency(projectData.amountRaised * 0.7)}
                  </p>
                  <p className="text-sm text-gray-600">Crowdfunds Raised</p>
                </div>
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <p className="text-xl md:text-2xl font-bold text-blue-600">
                    {formatCurrency(projectData.amountRaised * 0.3)}
                  </p>
                  <p className="text-sm text-gray-600">Private Investments</p>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <p className="text-xl md:text-2xl font-bold text-purple-600">{formatCurrency(myInvestmentAmount)}</p>
        ...
        <Dialog open={showInvestDialog} onOpenChange={setShowInvestDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Enter the additional amount you'd like to invest in this project.</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
                <Label htmlFor="amount">Additional Investment Amount</Label>
                <Input
                  id="amount"
                  type="number"
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Current investment: {formatCurrency(myInvestmentAmount)}</p>
              </div>
            </div>
            <DialogFooter>
              ...
              <Button className="bg-green-600 hover:bg-green-700">Invest ${investmentAmount}</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
