        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allCampaigns
              ...
              .slice(0, 3)
              .map((campaign) => (
                <Link href={`/investor/campaigns/${campaign.id}`} key={campaign.id} className="h-full">
                  <Card
                    key={campaign.id}
                ...
                <Table>
                  ...
                  <TableBody>
                    {paginatedCampaigns.map((campaign) => (
                      <Link href={`/investor/campaigns/${campaign.id}`} key={campaign.id} style={{ display: 'contents' }}>
                        <TableRow
                          key={campaign.id}
