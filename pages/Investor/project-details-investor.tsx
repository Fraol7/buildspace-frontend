...
import { projectData, ALL_PROJECTS, type ProjectCard } from "@/pages/Investor/shared-data"
...
export default function ProjectDetailsInvestor() {
        ...
        <Dialog open={showInvestDialog} onOpenChange={setShowInvestDialog}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Enter the amount you'd like to invest in this project.</DialogDescription>
            </DialogHeader>
